...
const Sidebar = () => {
  ...
  const toggleSidebar = () => {
    setIsOpen(!isOpen); // Toggle open/close sidebar
  };

  // Map the current path to the screen name
  const screenNames = {
    "/dashboard": "Overview",
    "/carbon-pools": "Carbon Pools",
    "/explorer": "Explorer",
  ...
  // Get the current screen name based on the path
  const currentScreenName =
    screenNames[location.pathname as keyof typeof screenNames] || "Dashboard";
