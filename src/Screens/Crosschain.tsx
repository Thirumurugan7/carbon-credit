...
const CrossChain = () => {
  ...
  const [balance, setBalance] = useState(0.0); // Simulated balance
          ...
          {selectedTokenScreen === "bridgeTokens" ? (
            <div className="p-6 bg-white shadow rounded-md">
              ...
              <p className="text-gray-600 mb-6">
                ...
                from one chain to another in a fast, safe, and secure way. Start
                by selecting the type of token you want to bridge.
              </p>
